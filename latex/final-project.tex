...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[x=12cm]
        ...
        (qc1) edge[left] node[pos=0.1]{\scriptsize $\lambda$} (qc2)
        (qc1) edge[left] node[pos=0.1]{\scriptsize $f$} (qfben)
        (qc1) edge[left] node[pos=0.1]{\scriptsize $f$} (qfbew1)
        (qc2) edge[right] node[pos=0.1]{\scriptsize $\lambda$} (qc3)
        ...
        (qmc1) edge[right] node[pos=0.1]{\scriptsize $\lambda$} (qmc2)
        ...
        (qsb1) edge[above] node[pos=0.1]{\scriptsize $\lambda$} (qsb2)
        (qsb2) edge[above] node[pos=0.1]{\scriptsize $\lambda$} (qsb3)
